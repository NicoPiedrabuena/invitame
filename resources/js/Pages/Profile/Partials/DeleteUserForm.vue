    ...
    <section class="space-y-6">
        <header>
            ...
            <p class="cm-body mt-2">
                Esta acción elimina permanentemente tus datos y recursos asociados.
            </p>
        </header>
        ...
        <Modal :show="confirmingUserDeletion" @close="closeModal">
            <div class="p-6">
                <h2
                    class="cm-title text-xl"
                >
                    ¿Querés eliminar tu cuenta?
                </h2>

                <p class="cm-body mt-2">
                    Para confirmar la eliminación definitiva, ingresá tu contraseña.
                </p>
